/* Carrara as the plugin sees it: how to install it, how to document it, how it
 * moves, and what the harness must measure. Only the plugin imports this
 * entry; apps use the authoring vocabulary in index.ts. */
...
export const designSystem: DesignSystemDefinition<MotionName> = Object.freeze({
  ...
  signatureComponents: Object.freeze([
    Object.freeze({ key: 'button-matrix', page: 'system', topLevel: 'C1 · Actions and inputs', node: 'row/primary' }),
  ]),
});
