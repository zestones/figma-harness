...
const { fromRoot, rendersDirectory } = require('../core/workspace.ts') as typeof import('../core/workspace.ts');
const dir = process.argv[2] ? fromRoot(process.argv[2]) : rendersDirectory();
