...
import { focusViewport } from '@figma-harness/engine';
import { PROTOTYPE } from './composition.ts';
import { wirePrototype } from './document/prototype.ts';
import {
  SCREEN_CATALOG,
...
} from './document/screen-catalog.ts';
import { PAGES } from './document/workspace.ts';
...
export const refreshSelectedScreen = async function (
  ...
  var rewiredLinks = await wirePrototype(catalog.frames, PROTOTYPE, {
