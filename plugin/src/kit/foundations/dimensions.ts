 ...
 * natively. Decision: docs/adr/0007-dimension-variables-and-native-bindings.md */
import type { DimensionField, DimensionReference } from '../../engine/dimension-bindings.ts';
