/*
 * Supported authoring surface for generated designs.
 *
 * Files under src/designs/ import construction vocabulary from this module
 * only. Internal kit and engine paths are deliberately not part of the design
 * authoring contract.
 */
...
export {
  ...
  span,
  split,
} from '../engine/layout-math.ts';
export {
  abs,
  add,
  f,
  strut,
} from '../engine/node-factory.ts';
export type { FrameOptions } from '../engine/node-factory.ts';
export { bindDimensions, setDimension } from '../engine/dimension-bindings.ts';
export {
  clearPage,
  focusViewport,
  getPage,
} from '../engine/pages.ts';
export {
  verifyPrototypeReactionReadback,
  writePrototypeReactions,
} from '../engine/prototype-reactions.ts';
export type {
  PrototypeAction,
  PrototypeBackAction,
  PrototypeNodeAction,
