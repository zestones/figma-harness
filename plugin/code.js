/* @generated by tools/runtime/build.ts — do not edit; run npm run build. */
"use strict";
var FigmaHarnessPlugin = (() => {
  ...
  // src/engine/dimension-bindings.ts
  ...
  // src/engine/prototype-reactions.ts
  ...
  // src/kit/foundations/primer.generated.ts
  ...
  // src/kit/foundations/dimensions.ts
  ...
  // src/kit/foundations/elevation.ts
  ...
  // src/kit/foundations/semantics.ts
  ...
  // src/kit/foundations/typography.ts
  ...
  // src/kit/primitives/icons.generated.ts
  ...
  // src/kit/primitives/primitives.ts
  ...
  // src/kit/primitives/visualization.ts
  var LABEL_HEIGHT = 20;
  var SEGMENT_GAP = 2;
  ...
  // src/kit/components/action-list.ts
  var ITEM_HEIGHT = 32;
  var INSET = 8;
  ...
  // src/kit/components/button/model.ts
  ...
  // src/kit/components/feedback.ts
  ...
  // src/kit/components/form-control.ts
  ...
  // src/kit/components/interaction-state.ts
  ...
  // src/kit/components/navigation.ts
  var NAV_HEIGHT = 48;
  ...
  // src/kit/components/progress.ts
  ...
  // src/kit/components/text-input.ts
  ...
  // src/kit/components/timeline.ts
  var BADGE = 32;
  var GUTTER = BADGE + 8;
  ...
  // src/kit/patterns/shell/app-header.ts
  ...
  // src/kit/patterns/shell/page-layout.ts
  ...
  // src/kit/patterns/blocks/page-header.ts
  ...
  // src/kit/patterns/blocks/data-table.ts
  var ROW_HEIGHT = 44;
  ...
  // src/designs/sheets/accessibility.ts
  ...
  // src/designs/sheets/components.ts
  var VARIANTS = [
  ...
  // src/designs/sheets/foundations.ts
  ...
  // src/designs/sheets/patterns.ts
  ...
  // src/designs/pages/render-cache.ts
  ...
  // src/designs/pages/state-matrix.ts
  ...
  // src/designs/screens.ts
  var SCREEN_CATALOG_VERSION = "relay-v1";
  var START_SCREEN_KEY = "overview";
  var SCREENS = Object.freeze(
    ALL_SCREENS.map((definition) => Object.freeze({
      key: definition.key,
  ...
  // src/designs/flows/prototype.ts
  ...
  var reactionFor = function(transition, destinationId) {
    ...
    return {
      ...
      actions: [{
        ...
        destinationId,
        navigation: "NAVIGATE",
        transition: transition.motion ? prototypeMotionTransition(transition.motion) : null,
  ...
  // src/designs/flows/flow-types.ts
  ...
  // src/designs/flows/relay-flow-matrix.ts
  ...
  // src/designs/flows/index.ts
  var PROTOTYPE_FLOWS = Object.freeze({
    transitions: RELAY_FLOW_TRANSITIONS
  });

  // src/designs/workspace.ts
  ...
  var DESIGN_LAB_ARCHIVE = Object.freeze([]);
  var LAST_LINKS;
  ...
  BUILDERS.system = async function() {
    ...
    for (var gi = 0; gi < groups.length; gi++) {
      var name = groups[gi];
      var members = SHEETS.filter(function(sh) {
  ...
  var GROUP_ORDER = ["Colour", "Foundations", "Components"];
  BUILDERS.states = async function() {
    ...
    page.setPluginData(
      ...
      DESIGN_LAB_ARCHIVE.map(function(entry) {
        return entry.id;
      }).join(",")
    );
  ...
  var ensureTokens = async function() {
  ...
  var refreshSelectedScreen = async function(page) {
    ...
    var rewiredLinks = await wirePrototype(catalog2.frames, PROTOTYPE_FLOWS, {
  ...
  // src/designs/flows/product-contract.ts
  ...
  // src/designs/pages/stress-cases.ts
  ...
  // src/designs/harness-contract.ts
  ...
  var FOCUS_STROKE_EXEMPTIONS = Object.freeze([
    (node) => node.name === "chip" && node.getPluginData("spec.swatch.token") === "focus/outline-color"
  ]);
  var PROTOTYPE_CONTRACT = Object.freeze({
    /** Every top-level frame the prototype may connect, by durable key. */
    frames: Object.freeze(PROTOTYPE_SCREENS.map((screen2) => Object.freeze({ key: screen2.key, title: screen2.title }))),
  ...
  // src/kit/components/inventory.ts
